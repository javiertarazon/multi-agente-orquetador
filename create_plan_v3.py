...
async def test():
    # Create a new plan with Windows-compatible validation commands
    plan_data = {
        ...
        'tasks': [
            {
                ...
                'validation_commands': [['cmd', '/c', 'echo', 'Task 0 completed successfully']],
                'depends_on': []
            },
            {
                ...
                'executor': 'simulated',
                'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
                'validation_commands': [['cmd', '/c', 'echo', 'Task 1 completed successfully']],
                'depends_on': [0]
            },
            {
                ...
                'executor': 'simulated',
                'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
                'validation_commands': [['cmd', '/c', 'echo', 'Task 2 completed successfully']],
                'depends_on': [1]
            },
            {
                ...
                'executor': 'simulated',
                'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
                'validation_commands': [['cmd', '/c', 'echo', 'Task 3 completed successfully']],
                'depends_on': [2]
            },
            {
                ...
                'executor': 'simulated',
                'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
                'validation_commands': [['cmd', '/c', 'echo', 'Task 4 completed successfully']],
                'depends_on': [3]
            },
            {
                ...
                'executor': 'simulated',
                'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
                'validation_commands': [['cmd', '/c', 'echo', 'Task 5 completed successfully']],
                'depends_on': [4]
            }
        ],
        'workspace': 'D:/datos jt7/proyectos/proyecto prueba/juego-pollo',
